...
if(isset($_POST['submit-search'])){
	...
	if(!isset($_POST['location']) and !isset($_POST['action-taken'])){
		header("Location:index.php?success=".urlencode("Search for keyword has been submitted."));
		exit();
	}
	
	else if(($_POST['location'] == '')){
		
		if($_POST['action-taken'] == '0'){
			header("Location:index.php?success=".urlencode("Search for Find Event submitted."));
			exit();
		}
		else if($_POST['action-taken'] == '1'){
			header("Location:index.php?success=".urlencode("Search for Find Artist has been submitted."));
			exit();
		}
		else if($_POST['action-taken'] == '2'){
			header("Location:index.php?success=".urlencode("Search for keyword has been submitted."));
			exit();
		}	
	}	
...
<html>
<head>
<title>My Night Life | Home</title>
...
<div class="header">
		   <div class="col-sm-8 header-left">
					 <div class="logo">
						<a href="index.php"> <h3 class="site-name">My Night Life</h3></a>
					 </div>
					 <div class="menu">
   		...
   		<h1>What are you looking for?</h1>
   	       <div class="dropdown-buttons">   
            		  <div class="dropdown-button">           			
            			<select class="dropdown" tabindex="9" name="location" data-settings='{"wrapperClass":"flat"}'>
            			<option value="">--Select Location--</option>	
            			<option value="0">Free State</option>	
				     ...
				     <div class="dropdown-button">
					  <select class="dropdown" tabindex="9" name="action-taken" data-settings='{"wrapperClass":"flat"}'>
            			<option value="">--Select Action--</option>	
            			<option value="0">Find Event</option>	
						<option value="1">Find Artist</option>
		    ...
		    <form action="" method="POST">
			    ...
			    <div class="contact_btn">
	               <label class="btn1 btn-2 btn-2g"><input name="submit-search" type="submit" id="submit" value="Search"></label>
	            </div>
			</form>        		
   		    <div class="clearfix"></div>
         </div>
   	  ...
   	  <div class="container">
		  ...
		  while($res = mysqli_fetch_assoc($query)){
			  ...
			  <div class="col-md-3 index-grids" >
   			  <div class="grid1" style="height:300px;">
                  ...
                  <div class="index_img1"><img src="images/'.$res['event_pic'].'" class="img-responsive" alt=""/></div>
   				     <div class="mask">
                 ...
                 <i class="home1"> </i>
   				 <div class="inner_wrap" style="height:150px;">
				 <ul class="star1">
   				 	  <h4 class="yellow">'.$res['event_name'].'</h4>
   				 	  <li><a href="#"> <img src="images/star2.png" alt="">(136)</a></li>
   				 	</ul>
   				 	<h3>'.$res['event_desc'].'</h3>
		  ...
		  <div class="col-md-12 text-center">
   		...
   		<div class="bottom_grid wow bounce" data-wow-delay="0.4s">
   		  ...
   		  <div class="offering">
   		  	  <h2>What can My Night Life offer to you ?</h2>
   		  	  <h3>Get connected with ease.</h3>
		  ...
		  <div class="footer-grid last_grid">
			...
			<ul class="footer_social wow fadeInLeft" data-wow-delay="0.4s">
		 	...
		 	<div class="copy wow fadeInRight" data-wow-delay="0.4s">
              <p> &copy; 2018 My Night Life. All rights reserved | Developed by <a href="http://lusani.lumardigital.co.za" target="_blank">Lumar Digital</a></p>
	        </div>
		  </div>
		  <div class="clearfix"> </div>
	   </div>
